...
import clc.Collecte;
import clc.CollecteFichier;

class SimpleGreffonEstUnFichier {
  ...
  static public void main (String[] args) throws TecException{
    ...
    Collecte collecte = new CollecteFichier("log/logEstUnFichier.txt");
    Transport serenity = FabriqueTec.faireGreffonEstUn(1, 2, collecte);
